...
class CodeTool {
  ...
  drawView() {
    ...
    console.log('table language', this.languageList)
    for (var language in this.languageList){
  ...
  static get DEFAULT_PLACEHOLDER() {
    return 'Insérer ou coller du code...';
  }
