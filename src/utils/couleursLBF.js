...
const couleur3 = []
couleur3[0] = { numCouleur: '#e32e39', espace: 'rencontre', variante: 'rouge', classText: 'text-rougeLBF', classBG: 'bg-rougeLBF', border: 'border-rougeLBF' }
couleur3[1] = { numCouleur: '#fcc62d', espace: 'brasserie', variante: 'jaune', classText: 'text-jauneLBF', classBG: 'bg-jauneLBF', border: 'border-jauneLBF' }
couleur3[2] = { numCouleur: '#4bbcc4', espace: 'coworking', variante: 'bleu', classText: 'text-bleuLBF', classBG: 'bg-bleuLBF', border: 'border-bleuLBF' }
couleur3[3] = { numCouleur: '#ee732e', espace: 'atelier', variante: 'orange', classText: 'text-orangeLBF', classBG: 'bg-orangeLBF', border: 'border-orangeLBF' }
couleur3[4] = { numCouleur: '#93c021', espace: 'jardin', variante: 'vert', classText: 'text-vertLBF', classBG: 'bg-vertLBF', border: 'border-vertLBF' }
couleur3[5] = { numCouleur: '#5e4b99', espace: 'autre', variante: 'violet', classText: 'text-violetLBF', classBG: 'bg-violetLBF', border: 'border-violetLBF' }
